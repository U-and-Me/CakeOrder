		...
		<form action="./processShippingInfo.jsp" class="form-horizontal" method="post">
			...
			<div class="form-group row">
				<div class="col-sm-offset-2 col-sm-10">
					<a href="./cart.jsp?cardId<%=request.getParameter("cartId")%>"class ="btn" style="background-color: #d8caad; color: #433e35" role="button">이전</a>
					<input type="submit" class="btn" style="background-color: #877f78; color: #ede5de" value="등록"/>
